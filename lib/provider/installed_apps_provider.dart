...
//   /// Fetches the installed applications via FFI, sorts them, and notifies listeners.
//   Future<void> fetchInstalledApps() async {
//     try {
//       final String jsonString = _systemInfo.getInstalledApplications();
//       if (jsonString.isEmpty) {
...
// // lib/provider/installed_apps_provider.dart
// import 'dart:convert';
// import 'package:flutter/foundation.dart';
// import '../services/macos_system_info.dart';
...
//   /// Fetches the installed applications via FFI and parses the JSON.
//   Future<void> fetchInstalledApps() async {
//     try {
//       final String jsonString = _systemInfo.getInstalledApplications();
//       if (jsonString.isEmpty) {
